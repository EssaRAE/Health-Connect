...
const mockAppointments = [
  {id: 1, date: new Date().toISOString().split('T')[0], patientId: 1},
  {id: 2, date: '2024-03-15', patientId: 2},
  {id: 3, date: new Date().toISOString().split('T')[0], patientId: 3}
]
...
export default function DashboardPage() {
  ...
  const appointments = useStore((state) => state.appointments) || mockAppointments; //added appointments
                    ...
                    {searchQuery ? (
                      filteredPatients.length > 0 ? (
                        filteredPatients.map((patient) => (
                          <PatientPortfolio key={patient.id} patient={patient} />
                        ))
                      ) : (
                      ...
                      <p className="text-center text-muted-foreground">
                        Search for a patient to view their medical portfolio
                      </p>
                    )}
                  </TabsContent>
